...
/***/ function(module, exports, __webpack_require__) {
	...
	var _maybee = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../src/maybee\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	document.addEventListener('DOMContentLoaded', function () {
	    ...
	    if (!(0, _maybee.isSupported)()) {
	        var _ret = function () {
	            var headerNode = document.querySelector('h3');
	            setTimeout(function () {
	                return headerNode.classList.add('visible');
	            }, 0);
	            return {
	                v: undefined
	            };
	    ...
	    var model = (0, _maybee.safeguard)({ animal: 'Bee', month: { current: 'May' } });

	    var write = function write(text) {
	        var ulNode = document.querySelector('.chalkboard');
	        var liNode = document.createElement('li');
	        liNode.innerHTML = '<span>' + (0, _moment2.default)().format('h:mm:ss a') + ':</span> ' + text;
	        ulNode.appendChild(liNode);
	    };

	    global.model = model;
	    global.isNull = _maybee.isNull;
	    global.isUndefined = _maybee.isUndefined;
	    global.write = write;

	    var headerStyle = 'color: #4096ee; font-weight: bold';
	    var lineStyle = 'color: #666; font-weight: normal';
	    var codeStyle = 'color: #ef6764; font-weight: bold';
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!locales[name]&&typeof module!=='undefined'&&module&&module.exports){try{oldLocale=globalLocale._abbr;__webpack_require__(3)("./"+name); // because defineLocale currently also sets the global locale, we
